...
🔭 **Currently Working On:** Building scalable ETL pipelines, mastering PySpark, and expanding my Azure Data Engineering expertise.

🌱 **Currently Learning:** Apache Spark Internals, Delta Lake, Databricks, Azure Data Factory, Synapse Analytics, Apache Airflow, Kafka, and advanced SQL optimization.

👯 **Looking to Collaborate:** Open-source Data Engineering projects, Spark applications, ETL frameworks, and cloud-native data platforms.

🤝 **Looking for Help With:** Distributed systems, Spark performance tuning, real-time data processing, and modern data architectures.

💼 **Experience:** Nearly **3 years** of experience as a **Data Engineer** in the Banking & Financial Services domain, specializing in ETL development, SQL optimization, big data processing, and cloud-based data solutions.

🏦 Built scalable ETL pipelines for regulatory reporting, enterprise analytics, and data warehousing using **Medallion Architecture (Bronze, Silver, Gold).**

🛠️ Experienced with SQL, Python, Talend, Apache Spark, Hive, Hadoop, Azure Data Factory, Azure Data Lake, Synapse Analytics, Linux, Git, Docker, and CI/CD.

📊 Passionate about Data Engineering, Distributed Systems, Lakehouse Architecture, Cloud Computing, Data Warehousing, and Performance Optimization.

🎯 **Goal:** Become an expert Cloud Data Engineer building scalable, high-performance enterprise data platforms.

🎓 Bachelor's Degree in Electronics & Communication Engineering from **MLR Institute of Technology**.

🎨 Previously served as a Graphic Designer and Senior Member of the Literature Club, and Graphic Designer for the ECE Robotics Club.
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=flat-square&logo=linkedin&logoColor=white)](https://linkedin.com/in/somavishal)
[![Gmail](https://img.shields.io/badge/Gmail-D14836?style=flat-square&logo=gmail&logoColor=white)](mailto:vishalkumar8999@gmail.com)
...
![Talend Administration Center](https://img.shields.io/badge/Talend%20Administration%20Center-FF6D00?style=flat-square&logo=talend&logoColor=white)
...
![SAP BusinessObjects](https://img.shields.io/badge/SAP%20BusinessObjects-0FAAFF?style=flat-square&logo=sap&logoColor=white)
...
![Adobe Lightroom](https://img.shields.io/badge/Adobe%20Lightroom-31A8FF?style=flat-square&logo=adobelightroom&logoColor=white)
...
A production-inspired **Banking Data Platform** implementing **Medallion Architecture (Bronze → Silver → Gold)** using PySpark, DuckDB, Delta Lake, Docker, MinIO, and Streamlit.
